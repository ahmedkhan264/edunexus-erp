...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Complete the admission form to enroll a new student</p>
        </div>
        <div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('admission_date') is-invalid @enderror" 
                                   id="admission_date" name="admission_date" value="{{ old('admission_date') ?? now()->format('Y-m-d') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" min="0" max="4" class="form-control @error('previous_school_gpa') is-invalid @enderror" 
                                   id="previous_school_gpa" name="previous_school_gpa" value="{{ old('previous_school_gpa') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('previous_school_name') is-invalid @enderror" 
                                   id="previous_school_name" name="previous_school_name" value="{{ old('previous_school_name') }}">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('father_cnic') is-invalid @enderror" 
                                   id="father_cnic" name="father_cnic" value="{{ old('father_cnic') }}" placeholder="XXXXX-XXXXXXX-X">
                            @error('father_cnic')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('mother_cnic') is-invalid @enderror" 
                                   id="mother_cnic" name="mother_cnic" value="{{ old('mother_cnic') }}" placeholder="XXXXX-XXXXXXX-X">
                            @error('mother_cnic')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('guardian_cnic') is-invalid @enderror" 
                                   id="guardian_cnic" name="guardian_cnic" value="{{ old('guardian_cnic') }}" placeholder="XXXXX-XXXXXXX-X">
                            @error('guardian_cnic')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('guardian_occupation') is-invalid @enderror" 
                                   id="guardian_occupation" name="guardian_occupation" value="{{ old('guardian_occupation') }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('guardian_address') is-invalid @enderror" 
                                      id="guardian_address" name="guardian_address" rows="2">{{ old('guardian_address') }}</textarea>
...
<script>
    ...
    document.getElementById('date_of_birth').addEventListener('change', function() {
        ...
        // Show age in console for debugging (can be displayed to user if needed)
