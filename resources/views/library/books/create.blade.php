                    ...
                    <form id="addBookForm" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="pages" name="pages" min="1" max="10000">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text">JPEG, PNG, JPG, or GIF (Max 2MB)</div>
                            </div>
                            <div class="col-12">
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        <div id="previewImage" class="preview-image">
                            <img src="https://via.placeholder.com/150x200/007bff/ffffff?text=Cover" 
                                 alt="Book Cover" class="img-fluid rounded">
                        </div>
                    </div>
                    <h6 id="previewTitle" class="text-center mb-2">Book Title</h6>
                    <p id="previewAuthor" class="text-muted text-center mb-2">Author Name</p>
                    <div class="text-center">
                        <span id="previewCategory" class="badge bg-secondary">Category</span>
                        <span id="previewStatus" class="badge bg-success">Available</span>
                    </div>
                    <hr>
                    <div class="small">
                        <div class="d-flex justify-content-between mb-1">
                            <span>ISBN:</span>
                            <span id="previewIsbn">-</span>
                        </div>
                        <div class="d-flex justify-content-between mb-1">
                            <span>Language:</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('{{ route('library.books.store') }}', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                showToast('Error', data.message || 'Failed to add book', 'error');
            }
        })
        .catch(error => {
        ...
        .finally(() => {
            submitBtn.innerHTML = '<i class="fas fa-save me-2"></i>Add Book';
