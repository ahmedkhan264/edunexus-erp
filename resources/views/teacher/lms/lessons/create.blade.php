...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Upload Lesson</h1>
            <p class="text-muted mb-0">Create and upload lesson materials for your students</p>
        </div>
        <div class="text-end">
            <a href="{{ route('teacher.lms.dashboard') }}" class="btn btn-outline-secondary">
                <i class="fas fa-arrow-left me-2"></i>Back to LMS
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">
                <i class="fas fa-upload me-2"></i>Lesson Details
            </h5>
        </div>
        <div class="card-body">
            <form id="lessonForm" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="title" name="title" required
                               placeholder="Enter lesson title..." maxlength="255">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="chapter" name="chapter"
                               placeholder="Enter chapter or topic..." maxlength="100">
                        <div class="form-text">Optional: Chapter number or topic name</div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="4"
                                  placeholder="Enter lesson description or objectives..." maxlength="1000"></textarea>
                        <div class="form-text">Optional: Brief description of the lesson content (max 1000 characters)</div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <label class="form-label">
                            <i class="fas fa-file-upload me-2"></i>Lesson Files
                            <small class="text-muted">(Optional - Max 10 files, 10MB each)</small>
                        </label>
                        <div class="file-upload-area" id="fileUploadArea">
                            <input type="file" class="form-control" id="files" name="files[]" 
                                   multiple accept=".pdf,.doc,.docx,.ppt,.pptx,.jpg,.jpeg,.png,.gif,.mp4,.mov,.webm"
                                   style="display: none;">
                            <div class="upload-placeholder text-center p-4 border border-2 border-dashed rounded">
                                ...
                                <p class="text-muted small mb-0">
                                    Supported formats: PDF, DOC, DOCX, PPT, PPTX, JPG, PNG, GIF, MP4, MOV, WEBM
                                </p>
                            </div>
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <label class="form-label">Lesson Status <span class="text-danger">*</span></label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="status_draft" 
                                   value="draft" checked>
                            <label class="form-check-label" for="status_draft">
                                <i class="fas fa-edit me-1"></i>Draft
                                <small class="text-muted">(Only you can see this lesson)</small>
                            </label>
                        </div>
                        <div class="form-check form-check-inline ms-3">
                            ...
                            <label class="form-check-label" for="status_published">
                                ...
                                <small class="text-muted">(Students can view this lesson)</small>
                            </label>
                        </div>
                    </div>
                </div>
...
<div class="loading-overlay" id="loadingOverlay" style="display: none;">
    ...
    <div class="mt-2">Creating lesson...</div>
</div>
...
function getFileIcon(mimeType) {
    if (mimeType.startsWith('image/')) {
        return { icon: 'fas fa-image', color: 'success' };
    } else if (mimeType.startsWith('video/')) {
        return { icon: 'fas fa-video', color: 'danger' };
...
function submitForm() {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            setTimeout(() => {
                window.location.href = '/teacher/lms/dashboard';
            }, 2000);
        } else {
            showToast('Error', data.message || 'Failed to create lesson.', 'error');
        }
    })
    .catch(error => {
        hideLoading();
        ...
        showToast('Error', 'Failed to create lesson. Please try again.', 'error');
    });
}
